    document.addEventListener('DOMContentLoaded', () => {
        ...
        // Fetch and display the most popular guides
        fetchGuides('/api/guides?category=macOS&limit=6', displayPopularGuides);
        ...
        function initializeSearch() {
            ...
            searchInput.addEventListener('input', (e) => {
                ...
                debounceTimeout = setTimeout(() => {
                    fetchGuides(`/api/guides/search?q=${encodeURIComponent(query)}`, (guides) => {
        ...
        document.getElementById('searchInput').addEventListener('keydown', (e) => {
            if (e.key === 'Enter') {
                ...
                const query = e.target.value.trim();
                if (query.length > 0) {
                    fetchGuides(`/api/guides/search?q=${encodeURIComponent(query)}`, displaySearchResults);
